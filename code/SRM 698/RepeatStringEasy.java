...
// CUT begin
	public static void main(String[] args){
		System.err.println("RepeatStringEasy (500 Points)");
		System.err.println();
	...
	static void runTest(HashSet<Integer> caseSet) {
        ...
        int T = (int)(System.currentTimeMillis() / 1000) - 1489952609;
	...
	static boolean doTest(String s, int __expected) {
		...
		int __result = 0;
		try {
			__result = instance.maximalLength(s);
		}
	...
	static class Reader {
        private static final String dataFileName = "RepeatStringEasy.sample";
